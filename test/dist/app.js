...
prevChildren, parentComponent, parentSuspense, unmountChildren) {
    ...
    try {
        ...
        if ((true)) {
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`Failed setting prop "${key}" on <${el.tagName.toLowerCase()}>: ` +
...
class VueElement extends BaseClass {
    constructor(_def, _props = {}, hydrate) {
        ...
        if (this.shadowRoot && hydrate) {
            ...
            if (( true) && this.shadowRoot) {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`Custom element has pre-rendered declarative shadow root but is not ` +
    ...
    disconnectedCallback() {
        this._connected = false;
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* nextTick */ "o"])(() => {
            if (!this._connected) {
...
function useCssModule(name = '$style') {
    /* istanbul ignore else */
    {
        ...
        if (!instance) {
            ( true) && Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`useCssModule must be called inside setup()`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        const modules = instance.type.__cssModules;
        if (!modules) {
            ( true) && Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`Current instance does not have CSS modules injected.`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        const mod = modules[name];
        if (!mod) {
            ( true) &&
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`Current instance does not have CSS module named "${name}".`);
            return _vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* EMPTY_OBJ */ "b"];
        }
        return mod;
    }
...
function useCssVars(getter) {
    ...
    if (!instance) {
        ( true) &&
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`useCssVars is called without current active component instance.`);
        return;
    }
    const setVars = () => setVarsOnVNode(instance.subTree, getter(instance.proxy));
    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* watchPostEffect */ "x"])(setVars);
    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onMounted */ "p"])(() => {
        const ob = new MutationObserver(setVars);
        ob.observe(instance.subTree.el.parentNode, { childList: true });
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onUnmounted */ "q"])(() => ob.disconnect());
    });
}
...
function validateDuration(val) {
    if (typeof val !== 'number') {
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`<transition> explicit duration is not a valid number - ` +
            `got ${JSON.stringify(val)}.`);
    }
    else if (isNaN(val)) {
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`<transition> explicit duration is NaN - ` +
...
const TransitionGroupImpl = {
    ...
    setup(props, { slots }) {
        const instance = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* getCurrentInstance */ "k"])();
        const state = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* useTransitionState */ "v"])();
        let prevChildren;
        let children;
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* onUpdated */ "r"])(() => {
        ...
        return () => {
            ...
            for (let i = 0; i < children.length; i++) {
                ...
                if (child.key != null) {
                    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* setTransitionHooks */ "u"])(child, Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* resolveTransitionHooks */ "t"])(child, cssTransitionProps, state, instance));
                }
                else if ((true)) {
                    Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`<TransitionGroup> children must be keyed.`);
                }
            }
            if (prevChildren) {
...
function setSelected(el, value) {
    ...
    if (isMultiple && !Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isArray */ "o"])(value) && !Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isSet */ "B"])(value)) {
        ( true) &&
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`<select multiple v-model> expects an Array or Set value for its binding, ` +
...
function ensureRenderer() {
    return (renderer ||
        (renderer = Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* createRenderer */ "g"])(rendererOptions)));
}
...
function injectCompilerOptionsCheck(app) {
    if (Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* isRuntimeOnly */ "n"])()) {
        ...
        Object.defineProperty(app.config, 'isCustomElement', {
            ...
            set() {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`The \`isCustomElement\` config option is deprecated. Use ` +
        ...
        Object.defineProperty(app.config, 'compilerOptions', {
            get() {
                Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(msg);
...
function normalizeContainer(container) {
    if (Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_0__[/* isString */ "D"])(container)) {
        ...
        if (( true) && !res) {
            Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`Failed to mount app: mount target selector "${container}" returned null.`);
        }
        return res;
    }
    if (( true) &&
        ...
        Object(_vue_runtime_core__WEBPACK_IMPORTED_MODULE_1__[/* warn */ "w"])(`mounting on a ShadowRoot with \`{mode: "closed"}\` may lead to unpredictable bugs`);
    }
    return container;
}
